...
const socialLinks = [
  { title: 'LinkedIn', path: 'https://linkedin.com/in/MathewMusyoka', icon: FaLinkedin },
  { title: 'GitHub', path: 'https://github.com/MathewKioko', icon: FaGithub },
  ...
  { title: 'WhatsApp', path: 'https://wa.me/254101737471', icon: FaWhatsapp },
  //{ title: 'Telegram', path: 'https://t.me/Mathew', icon: FaTelegram },
      ...
      <div className="relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <form
              action="https://formsubmit.co/mathewkioko34@gmail.com"
              method="POST"
