...
const socialLinks = [
  { title: 'GitHub', path: 'https://github.com/MathewKioko', icon: 'github.svg' },
  { title: 'LinkedIn', path: 'https://linkedin.com/in/MathewMusyoka', icon: 'linkedin.svg' },
  { title: 'Twitter', path: 'https://twitter.com/MathewKioko', icon: 'twitter.svg' }
]
